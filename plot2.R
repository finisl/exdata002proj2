...
NEI_fips24510_pivot <- ddply(NEI_fips24510, .(year), summarize, emission_thousand = sum(Emissions, na.rm=TRUE))
...
# Plot the result
png("plot2.png")
plot(NEI_fips24510_pivot, type="o", col="blue", xlab="year", ylab="PM2.5 Emissions (thousand tons)",main="Baltimore PM2.5 Emissions by Year")
dev.off()
