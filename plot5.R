...
NEI_fips24510_motor <- NEI[(NEI$fips=="24510" & NEI$type=="ON-ROAD"),]
NEI_fips24510_motor_pivot <- ddply(NEI_fips24510_motor, .(year), summarize, emission = sum(Emissions, na.rm=TRUE))



# Plot the result
png("plot5.png")
plot(NEI_fips24510_motor_pivot, type="o", col="blue", xlab="year", ylab="PM2.5 Emissions (tons)",main="Baltimore motor-vehicle PM2.5 Emissions by Year")
dev.off()
